...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-g-arkbw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-g-arkbw.containers.anotherwebservice.com/
...
```
git clone git@github.com:Faviod1/container-g-arkbw.git
cd container-g-arkbw
```
...
```
docker attach container-g-arkbw
```
